  ...
  skill_data: [
    {
      ...
      items: [
        {
          img: "/assets/img/skill/nextjs-react.svg",
          title: "Next & React JS",
          percent: 90
        },
        {
          img: "/assets/img/skill/css3.svg",
          title: "CSS",
          percent: 85
        },
        {
        ...
        {
          img: "/assets/img/skill/html5.svg",
          title: "HTML",
          percent: 95
        },
        {
          img: "/assets/img/skill/mongodb.svg",
          title: "MongoDB",
          percent: 88
        },
        {
          img: "/assets/img/skill/node.svg",
          title: "Node JS",
          percent: 82
        }
      ],
                            ...
                            <div className="tp-skill-item text-center">
                              <div
                                ...
                                <div className="tp-skill-icon">
                                  <span>
                                    {typeof inner_item.img === 'string' ? (
                                      <Image src={inner_item.img} alt={inner_item.title} width={50} height={50} unoptimized />
                                    ) : (
