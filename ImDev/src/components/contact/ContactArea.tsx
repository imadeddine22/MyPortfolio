...
import contact_img from "@/assets/img/contact/contact.png";
...
const contact_content: DataType = {
  ...
  categorys: [
    ...
    { id: "fullstack", title: "Full-Stack Project" },
    { id: "api_integration", title: "API Integration" },
    { id: "database", title: "Database Setup" },
    { id: "cms", title: "CMS / E-Commerce " },
    { id: "deployment", title: "Deployment & Hosting" },
