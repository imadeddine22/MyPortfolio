...
const service_info_content: DataType = {
  description: <>End-to-end web solutions <br /> from clean front-end interfaces to robust back-end systems, <br /> ensuring performance, scalability, and user-friendly experiences.</>,
